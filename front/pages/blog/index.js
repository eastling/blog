...
const Blog = ({ result }) => {
  const dashboardData = [{
    ...
    imgTitle: '随便截取的图片',
    name: '技术',
    content: `「技术」是我记录WEB端开发的文章，目前主要在于前端，共有${result['tech']}篇文章。`
  }, {
    url: '/blog/essay',
    imgUrl: '/static/img/essay_eb.jpg',
    imgTitle: 'E·B 怀特在写作',
    name: '随笔',
    content: `「随笔」是我记录除「技术」之外其他文章，主要是生活经历和思考，共有${result['essay']}篇文章。`
  }, {
    url: '/blog/card',
    imgUrl: '/static/img/nbkf_card.jpg',
    imgTitle: '纳博科夫的卡片',
    name: '卡片',
    content: `「卡片」信息值得记录，却还不够形成文章。以技术细节为主。共有${result['card']}张卡片。`
  }]
